...
<head>
    ...
    <title>Welcome to AI69 Bank</title>
...
<body class="bg-gray-50">
    ...
    <header class="gradient-bg shadow-lg">
        <div class="container mx-auto px-6 py-4 flex items-center justify-between">
            <h1 class="text-2xl font-bold text-black header-font">AI69 Bank</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="relative group">
                ...
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-white font-bold text-xl">AI69 Skybanking</h3>
                </div>
            </div>
            ...
            <div class="relative group">
                <img src="./images/The Secret to Investing Overseas.jpeg" alt="Retail Deposit" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-white font-bold text-xl">AI69 WOMEN BANKING</h3>
                </div>
            </div>
             ...
             <div class="relative group">
                <img src="./images/The Secret to Investing Overseas.jpeg" alt="Retail Deposit" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-white font-bold text-xl">AI69 SME LOAN</h3>
                </div>
            </div>
             <!-- Service Item 4 -->
             <div class="relative group">
                <img src="./images/The Secret to Investing Overseas.jpeg" alt="Retail Deposit" class="w-full h-48 object-cover rounded-lg">
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition duration-300">
                    <h3 class="text-white font-bold text-xl">AI69 SME Deposit</h3>
                </div>
            </div>
   ...
   <!-- Footer Section -->
    <footer class="bg-gray-800 text-gray-200 py-10">
        <div class="container mx-auto px-6 md:grid md:grid-cols-3 md:gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>Email: <a href="mailto:support@abcdbank.com" class="hover:text-gray-400">support@AI69bank.com</a></li>
        ...
        <div class="mt-8 text-center text-sm text-gray-500">
            © 2024 AI69 Bank. All rights reserved.
        </div>
    </footer>
